...
public class StudentService {
    ...
    public void updateRecord(Student student) {
        ...
        jdbcTemplate.update(sqlStatement, student.getFirst_name(),student.getLast_name(),
                student.getGender(),student.getCountry_code(),student.getContact_no(),student.getHouse_no(),
                student.getPostcode(),student.getCourse_id(),student.getGraduated(), student.getStudent_id());
    }
